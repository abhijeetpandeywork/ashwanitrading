...
$subs=[
  ...
  "POWER TOOLS"=>"Angle grinders, drills, jig saws, heat guns Ã¢â‚¬" corded & cordless.",
  ...
  "others"=>"Specialised fluid services Ã¢â‚¬" contact us for your specific requirement.",
  ...
  "On-Site Hydraulic Repair"=>"Mobile hydraulic repair Ã¢â‚¬" hose replacement, seal kits & pump work.",
...
<section class="page-hero" style="background: linear-gradient(90deg, rgba(11,77,44,0.95) 0%, rgba(11,77,44,0.2) 100%), url('/assets/img/hero_services.webp') center/cover; padding: 140px 0 120px; color: #fff; text-align: left; border-bottom: 5px solid var(--gold);">
  <div class="container page-hero__inner" style="max-width: 1200px; margin: 0 auto; display: flex; flex-direction: column; align-items: flex-start;">
    ...
    <p style="font-size: 20px; line-height: 1.6; opacity: 0.92; text-shadow: 0 2px 10px rgba(0,0,0,0.7); max-width: 640px; font-weight: 500;">Genuine spare parts, industrial lubricants, professional tools, expert repairs and flexible equipment rentals Ã¢â‚¬" serving Jammu, Kashmir &amp; Ladakh for 60+ years.</p>
    <nav class="hero-svc-nav" style="display:flex; gap:10px; flex-wrap:wrap; margin-top:32px;">
      <a href="#spare-parts" class="hero-svc-link">01 Ã¢â‚¬" Spare Parts</a>
      <a href="#lubricants"  class="hero-svc-link">02 Ã¢â‚¬" Lubricants &amp; Oils</a>
      <a href="#tools"       class="hero-svc-link">03 Ã¢â‚¬" Tools &amp; Equipment</a>
      <a href="#workshop"    class="hero-svc-link">04 Ã¢â‚¬" Services &amp; Repairs</a>
      <a href="#rentals"     class="hero-svc-link">05 Ã¢â‚¬" Machinery Rentals</a>
    </nav>
  </div>
</section>
...
echo "<p>Quality lubrication is the most cost-effective way to extend machine life. Full range of industrial-grade oils, greases, coolants and lubrication equipment Ã¢â‚¬" with professional specification advice.</p>";
echo "</div><div class=\"services-grid\" style=\"margin-top:40px;\">";
...
echo "<p>Complete spectrum of professional tools and industrial supplies Ã¢â‚¬" from precision hand tools and pneumatic equipment to heavy lifting gear, safety PPE and drilling wear parts.</p>";
echo "</div><div class=\"services-grid\" style=\"margin-top:40px;\">";
$d=2;
...
<section class="cta-band">
  <div class="container">
    ...
    <p data-reveal data-reveal-delay="1">Call us and describe your situation. Our 60+ year expert team will guide you to the right solution Ã¢â‚¬" fast.</p>
